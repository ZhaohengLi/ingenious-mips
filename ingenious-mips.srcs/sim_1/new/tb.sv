...
parameter BASE_RAM_INIT_FILE = "../../../../ingenious-mips.kernel/initrd(5).bin"; //BaseRAM初始化文件，请修改为实际的绝对路�???
parameter EXT_RAM_INIT_FILE = "";    //ExtRAM初始化文件，请修改为实际的绝对路�???
parameter FLASH_INIT_FILE = "../../../../ingenious-mips.kernel/initrd(5).bin";    //Flash初始化文件，请修改为实际的绝对路�???
